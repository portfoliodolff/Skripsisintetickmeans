    ...
    <div class="container margin-b50 margin-t50">
      <div class="row">
          ...
          <nav class="navbar navbar-default navbar-utama nav-admin-data" role="navigation">
            <div class="container-fluid">
              ...
              <div class="navbar-header">
                ...
                <?php
                  if($status == 'baru'){
                  echo "</i> Tambah Data Recency</a>";
                  }
                  else {
                  echo "</i> Edit Data Recency</a>";
                  }
                ?>
              </div>
        ...
        <div class="row">
          <div class="col-md-6 col-md-offset-3">
            <div class="well">
              <form class="form-horizontal" role="form" method="post" action="<?=base_url();?>administrasi/data_recency_save" enctype="multipart/form-data">
                <input type="hidden" class="form-control" name="id_recency" value="<?=$id_recency ?>" />
                ...
                <div class="form-group">
                  <label for="inputNama" class="col-sm-3 control-label">Tanggal Transaksi Terakhir</label>
                  <div class="col-sm-6">
                  <div class="left-inner-addon">
                  <i class="fa fa-plus-circle"></i>
                      <input type="text" name="transaksiterakhir" required class="form-control"  value="<?php echo $transaksiterakhir ?>" id="inputNama" placeholder="Tanggal Transaksi Terakhir" />
                      </div>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="left-inner-addon">
                  <i class="fa fa-plus-circle"></i>
                      <input name="recency" required type="text" class="form-control" id="inputNama" value="<?php echo $recency?>" placeholder="Recency" />
                      </div>
                  </div>
                </div>
