    ...
    <div class="container margin-b50 margin-t50">
      <div class="row">
          ...
          <nav class="navbar navbar-default navbar-utama nav-admin-data" role="navigation">
            <div class="container-fluid">
              ...
              <div class="navbar-header">
                <a class="navbar-brand" href="#"><i class="fa fa-plus-circle"></i> Tambah Data Frequency</a>"
        ...
        <div class="col-md-7 ">
            ...
            <form method="POST" action="<?php echo base_url('administrasi/importExcelfrequency') ?>" enctype="multipart/form-data">
