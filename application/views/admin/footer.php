    <div class="footer footer1">
      ...
      <div class="row">
        <div class="col-md-4 col-md-offset-4">
          <img src="<?php echo base_url();?>assets/images/logo-flag.png" width="72" height="72" />
          <h4 class="white">SINTETIC STORE </h4>
          <!-- <?php foreach ($titlesistem as $t): ?>
            <h3 class="white"><?php echo $t['title']?></h3>             
          <?php endforeach ?> -->
          <ul class="list-inline">
          <li><a href="<?php echo base_url();?>" class="link-footer">Beranda</a></li>
            <li><a href="<?php echo base_url();?>petunjuk" class="link-footer">Petunjuk </a></li>
            <li><a href="<?php echo base_url();?>tentang" class="link-footer">Tentang</a></li>
          </ul>
          <h5 class="white">Copyright &copy; <?php echo date("Y")?> | Distributed By. 1718022 </h5>
        </div>
      </div>
    </div>
  </div>
