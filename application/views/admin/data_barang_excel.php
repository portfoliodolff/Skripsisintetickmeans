    ...
    <div class="container margin-b50 margin-t50">
      <div class="row">
          ...
          <nav class="navbar navbar-default navbar-utama nav-admin-data" role="navigation">
            <div class="container-fluid">
              ...
              <div class="navbar-header">
                <a class="navbar-brand" href="#"><i class="fa fa-plus-circle"></i> Tambah Data Barang</a>"
        ...
        <div class="col-md-7 ">
            ...
            <form method="POST" action="<?php echo base_url('administrasi/excelbarang') ?>" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-md-7 ">
            <?php echo $this->session->flashdata('notif') ?>
            <?php echo form_open_multipart('administrasi/excelbarang',array('name' => 'spreadsheet')); ?>
            <div class="form-group">
                <label for="exampleInputEmail1">UNGGAH FILE EXCEL</label>
