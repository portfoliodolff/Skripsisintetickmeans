    ...
    <nav class="navbar navbar-default navbar-utama" role="navigation">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo base_url();?>managertoko/dashboard">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-left">
            <li class="active"><a href="<?php echo base_url();?>managertoko/dashboard"><i class="fa fa-home"></i> Beranda</a></li>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu tipe-kiri dropdown-menu-login2">
                <!-- <li><a href="<?php echo base_url(); ?>managertoko/generate_rata"><i class="fa fa-tags"></i> Generate Nilai Rata Rata Dan Centroid</a></li> -->
                <li><a href="<?php echo base_url(); ?>managertoko/tampilan_iterasi"><i class="fa fa-tags"></i> Iterasi K-Means</a></li>
                
              </ul>
            </li>
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"><i class="fa fa-th-list"></i> Cetak Data <i class="fa fa-caret-down"></i></a>
              <ul class="dropdown-menu tipe-kiri dropdown-menu-login2">
                <li><a href="<?php echo base_url(); ?>managertoko/cetak_barang"><i class="fa fa-tags"></i>Cetak Data Barang</a></li>
                <li><a href="<?php echo base_url(); ?>managertoko/cetak_penjualan"><i class="fa fa-tags"></i> Cetak Data Penjualan</a></li>
                <li><a href="<?php echo base_url(); ?>managertoko/cetak_kmeans"><i class="fa fa-tags"></i> Cetak Data Kmeans</a></li>
              </ul>
            </li>
            </ul>
