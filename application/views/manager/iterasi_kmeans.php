          ...
          <h1>Proses K-MEANS</h1>
            ...
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title">Tampilan Iterasi K-Means</h3>
              </div>
            ...
            <table  id="table_data" class="table table-bordered table-admin">
              ...
              <tr align="center">
              <td>365</td> <td>1500</td><td>2712</td>
              <td>363</td> <td>750</td><td>95</td>
              <td>364</td> <td>500</td><td>90</td>
              </tr>
              ...
              // $c3b = "";
              // $c3c = "";
              // foreach($centroid_awal->result_array() as $c)
              // {
              //   $c1a = $c['c1a'];
              //   $c1b = $c['c1b'];
              //   $c1c = $c['c1c'];
              ...
              $this->db->query('truncate table hasilkmeans');
              ...
              ?></td>
              <td colspan="3"><?php 
                $hc3 = sqrt(pow(($s['recency']-$c2a),2)+pow(($s['klasifikasi']-$c3b),2)+pow(($s['frequency']-$c3c),2));
                echo $hc3;
              ?></td>
              <?php 
              ...
              $this->db->query($q);
              $z = "insert into hasilkmeans(iterasi,no_barang,namabarang,c1,c2,c3) values(1,'".$s['no_barang']."','".$s['namabarang']."','".$hc1."','".$hc2."','".$hc3."')";
              $this->db->query($z);
